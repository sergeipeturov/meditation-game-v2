...
public static class Directions
{
    ...
    public static Vector3[] LeftRightDirectionsNoStay { get { return new Vector3[] { Right, Left }; } }
    ...
    public static Vector3 GetRandomLeftRightDirection()
    {
        int currentMoveDirection = Mathf.FloorToInt(Random.Range(0, LeftRightDirectionsNoStay.Length));
        Vector3 direction = LeftRightDirectionsNoStay[currentMoveDirection];
        return direction;
    }
}
